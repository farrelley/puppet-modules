class httpd {
  ...
  file { 
    "/var/www/sites": ensure => "directory",
  }

  file {
    [
      "/usr/local/apache", "/usr/local/apache/htdocs"
    ]: ensure => "directory",
  }

  file {
    [
      "/var/cache/apache", "/var/cache/apache/wsdl_cache", "/var/tmp/php" 
    ]:
      ensure  => "directory",
      owner   => "apache",
      group   => "apache",
  ...
  file {
    "/var/log/httpd": ensure => "directory",
  }

  file {
    "/etc/httpd": ensure => "directory",
  }
